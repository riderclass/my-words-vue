    ...
    <div v-if="word.active">
      <div class="single-word-box">
        ...
        <div
          ...
          class="btn-area-one"
        >
          <button @click="isShowKeyboard = true" class="btn-one btn-eff-one">
            <i class="gg-keyboard"></i>
          </button>
          <button @click="isShowWord = true" class="btn-one btn-eff-one">
            <i class="gg-eye"></i>
          </button>
          <button @click="isShowTest = true" class="btn-one btn-eff-one">
  ...
  methods: {
    playWord() {
      ...
      if (screen && screen.width < 768) {
        this.greetingSpeech.voice = this.voiceList[6];
      } else {
        this.greetingSpeech.voice = this.voiceList[51];
      }
